...
<h5 class="text-white ml-4 d-inline text-uppercase"><a href="{{ route('dashapplication.charteuro') }}" style="color: white;text-decoration: none">Dashboard</a> </h5>
...
<div class="etat_div">
    <ul class="list-inline">
        <li class="list-inline-item "><a href="{{route('dashapplication.charteuro')}}" class="active">STATISTIQUES</a></li>
            ...
            <form action="">
                <div class="form-group">
                  <select class="form-control" id="sampleSelect">
                    <option value="{{ route('dashapplication.charteuro') }}" selected >Euro (€)</option>
