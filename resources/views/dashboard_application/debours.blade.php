...
<div class="etat_div">
    <ul class="list-inline">
        ...
        <li class="list-inline-item"><a href="{{ route('dashapplication.debours') }}" class="active">DÉBOURS</a></li>
    </ul>
</div>
                ...
                <tbody>
                        ...
                        <tr>
                            ...
                            @for($j = 0; $j<count($keys_avoir_dirham); $j++)
                                @if($keys_facture_dirham[$i]===$keys_avoir_dirham[$j])
                                    <td>{{$total_debours_avoir_monthly_dirham[$j]}}&nbsp;DH</td>
                                    @php
                                        $total = $total_debours_avoir_monthly_dirham[$j]
                                    @endphp
                                    @break
                                @endif
                                @php
                            ...
                            <td>{{$total_debours_facture_monthly_dirham[$i]}}&nbsp;DH</td>
                            @else
                            <td>{{$total_debours_facture_monthly_dirham[$i] - $total }}&nbsp;DH</td>
                            @endif
                        </tr>
                    @endfor
                        ...
                        <tr>
                            ...
                            @for($j = 0; $j<count($keys_avoir_dollar); $j++)
                                @if($keys_facture_dollar[$i]===$keys_avoir_dollar[$j])
                                    <td>{{$total_debours_avoir_monthly_dollar[$j]}}&nbsp;$</td>
                                    @php
                                        $total = $total_debours_avoir_monthly_dollar[$j]
                                    @endphp
                                    @break
                                @endif
                                @php
                            ...
                            <td>{{$total_debours_facture_monthly_dollar[$i]}}&nbsp;$</td>
                            @else
                            <td>{{$total_debours_facture_monthly_dollar[$i] - $total }}&nbsp;$</td>
                            @endif
                        </tr>
                    @endfor
                    ...
                    @for($i = 0; $i<count($keys_facture_euro); $i++)
                        ...
                        @for($j = 0; $j<count($keys_avoir_euro); $j++)
                            @if($keys_facture_euro[$i]===$keys_avoir_euro[$j])
                                <td>{{$total_debours_avoir_monthly_euro[$j]}}&nbsp;€</td>
                                @php
                                    $total = $total_debours_avoir_monthly_euro[$j]
                                @endphp
                                @break
                            @endif
                            @php
                        ...
                        <td>{{$total_debours_facture_monthly_euro[$i]}}&nbsp;€</td>
                        @else
                        <td>{{$total_debours_facture_monthly_euro[$i] - $total }}&nbsp;€</td>
                        @endif
                        </tr>
                    @endfor
                    <tr>
                        ...
                        <td class="font-weight-bold" >
                            ...
                            @for($i=0 ;$i<count($total_debours_facture_monthly_dirham);$i++)
                                 @php
                                     $somme_facture_dirham += $total_debours_facture_monthly_dirham[$i]
                                 @endphp
                            @endfor
                        ...
                        <td class="font-weight-bold" >
                            ...
                            @endphp
                            @for($i=0 ;$i<count($total_debours_avoir_monthly_dirham);$i++)
                                @php
                                    $somme_avoir_dirham += $total_debours_avoir_monthly_dirham[$i]
                                @endphp
                            @endfor
                    ...
                    <tr>
                        ...
                        <td class="font-weight-bold" >
                            ...
                            @endphp
                            @for($i=0 ;$i<count($total_debours_facture_monthly_dollar);$i++)
                                 @php
                                     $somme_facture_dollar += $total_debours_facture_monthly_dollar[$i]
                                 @endphp
                            @endfor
                        ...
                        <td class="font-weight-bold" >
                            ...
                            @endphp
                            @for($i=0 ;$i<count($total_debours_avoir_monthly_dollar);$i++)
                                @php
                                    $somme_avoir_dollar += $total_debours_avoir_monthly_dollar[$i]
                                @endphp
                            @endfor
                    ...
                    <tr>
                        ...
                        <td class="font-weight-bold" >
                            ...
                            @endphp
                            @for($i=0 ;$i<count($total_debours_facture_monthly_euro);$i++)
                                 @php
                                     $somme_facture_euro += $total_debours_facture_monthly_euro[$i]
                                 @endphp
                            @endfor
                            {{$somme_facture_euro}}&nbsp;€
                        </td>
                        <td class="font-weight-bold" >
                            @php
                                $somme_avoir_euro = 0
                            @endphp
                            @for($i=0 ;$i<count($total_debours_avoir_monthly_euro);$i++)
                                @php
                                    $somme_avoir_euro += $total_debours_avoir_monthly_euro[$i]
                                @endphp
                            @endfor
                            {{$somme_avoir_euro}}&nbsp;€</td>
                        <td class="font-weight-bold" >
