...
<h2 id="grand_title_addclient" class="text-uppercase">Modifier&nbsp;l'avoir&nbsp;pour&nbsp;{{$clients->nom_client}}&nbsp;{{$clients->prenom_client}}</h2>
@endsection
@section('contenu_inside')
<div class="contain_inside">
    <div class="card-body">
        <form action="{{route('avoirs.update',$avoir->id)}}" method="post" id="bigform">
            @csrf
            @method('PUT')
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="div form-group">
                            <input type="number" value="{{$avoir->remised}}" name="remise" id="remise" placeholder="remise"
                ...
                <div class="row bg-light form-group rounded-sm">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row mb-1">
                            ...
                            class="col-md-3 font-weight-bold border-0 bg-transparent" readonly id="remise_general" value="{{$avoir->remise_genf}}"
                                placeholder="0.00">
                            <span class="col-md-3 font-weight-bold spn_devis">DH</span>
                        </div>
                        <div class="row mb-2">
                        ...
                        <div class="row mb-1">
                            ...
                            <input type="number" name="debours_final_last"
                                ...
                                placeholder="0.00" value="{{$avoir->total_debours}}">
                            <span class="col-md-3 font-weight-bold spn_devis">DH</span>
                        </div>
                        <div class="row my-1">
                ...
                <div class="row">
                    <div class="col-md-6 form-group">
                        ...
                        <select name="condition_reglement" id="conditions_reglement" class="form-control">
                            <option value="A Réception" @if($avoir->condition_reglf == 'A Réception') selected @endif>A Réception</option>
                            <option value="Fin de mois" @if($avoir->condition_reglf == 'Fin de mois') selected @endif>Fin de mois</option>
                            <option value="10 Jours" @if($avoir->condition_reglf == '10 Jours') selected @endif>10 Jours</option>
                            <option value="30 Jours" @if($avoir->condition_reglf == '30 Jours') selected @endif>30 Jours</option>
                            <option value="30 Jours Fin De Mois" @if($avoir->condition_reglf == '30 Jours Fin De Mois') selected @endif>30 Jours Fin De Mois</option>
                            <option value="60 Jours Fin De Mois" @if($avoir->condition_reglf == '60 Jours Fin De Mois') selected @endif>60 Jours Fin De Mois</option>
                            <option value="60 Jours" @if($avoir->condition_reglf == '60 Jours') selected @endif>60 Jours</option>
                            <option value="120 Jours Fin De Mois" @if($avoir->condition_reglf == '120 Jours Fin De Mois') selected @endif>120 Jours Fin De Mois</option>
                            <option value="120 Jours" @if($avoir->condition_reglf == '120 Jours') selected @endif>120 Jours</option>
                        </select>
                    </div>
                    <div class="col-md-6">
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6 form-group">
                        ...
                        <select name="mode_reglement" id="mode_reglement" class="form-control">
                            <option value="Non spécifié" @if($avoir->mode_reglf == 'Non spécifié') selected @endif>Non spécifié</option>
                            <option value="Virement bancaire" @if($avoir->mode_reglf == 'Virement bancaire') selected @endif>Virement bancaire</option>
                            <option value="Carte bancaire" @if($avoir->mode_reglf == 'Carte bancaire') selected @endif>Carte bancaire</option>
                            <option value="PayPal" @if($avoir->mode_reglf == 'PayPal') selected @endif>PayPal</option>
                            <option value="Espèces" @if($avoir->mode_reglf == 'Espèces') selected @endif>Espèces</option>
                        </select>
                    </div>
                    <div class="col-md-6">
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6 form-group">
                        ...
                        <select name="interet" id="interet" class="form-control">
                            <option value="none" @if($avoir->interet_reglf == 'none') selected @endif>Pas d'intérêts de retard</option>
                            <option value="1% par mois" @if($avoir->interet_reglf == '1% par mois') selected @endif>1% par mois</option>
                            <option value="1,5% par mois" @if($avoir->interet_reglf == '1,5% par mois') selected @endif>1,5% par mois</option>
                            <option value="2% par mois" @if($avoir->interet_reglf == '2% par mois') selected @endif>2% par mois</option>
                            <option value="Taux d’intérêt légal en vigueur" @if($avoir->interet_reglf == 'Taux d’intérêt légal en vigueur') selected @endif>Taux d’intérêt légal en vigueur</option>
                            <option value="À préciser" @if($avoir->interet_reglf == 'À préciser') selected @endif>À préciser</option>
                        </select>
                    </div>
                    <div class="col-md-6">
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" name="compte_bancaire" id="compte_bancaire" placeholder="Compte bancaire"
                            class="form-control" value="{{$avoir->code_bancf}}">
                    </div>
                    <div class="col-md-6">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 form-group">
                        <textarea name="text_intro" cols="30" rows="3" class="form-control"
                            placeholder="Texte d'introduction (visible sur la facture)">{{$avoir->text_introductionf}}</textarea>
                    </div>
                    <div class="col-md-6">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 form-group">
                        <textarea name="text_concl" cols="30" rows="3" class="form-control"
                            placeholder="Texte de conclusion (visible sur la facture)">{{$avoir->text_conclusionf}}</textarea>
                    </div>
                    <div class="col-md-6">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 form-group">
                        <textarea name="text_pied" cols="30" rows="3" class="form-control"
                            placeholder="Pied de page (visible sur la facture)">{{$avoir->pied_pagef}}</textarea>
                    </div>
                    <div class="col-md-6">
                    </div>
                </div>
            ...
            <div class="row">
                <div class="d-flex justify-content-end contain_button_submit mt-2" style="padding-left:30px;padding-top:10px;">
                    <a href="{{ route('factures.index') }}" class="btn addclient_retour  btn-danger rounded font-weight-bold"><span><i class="fas fa-backspace font-weight-bold" style="margin-right:-6px"></i></span> Annuler</a>
                    <button type="submit" id="addclient_sumbit_button" class=" btn btn-warning rounded font-weight-bold"><span><i class="far fa-edit font-weight-bold" style="color:#212529"></i></span>Modifier l'avoir</button>
                </div>
                <div class="col-md-6">
                </div>
            </div>
...
@endsection
@section('script')
<script src="{{asset('js/editavoir.js')}}"></script>
<script>
