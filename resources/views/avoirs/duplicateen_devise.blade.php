...
<div class="contain_inside">
    <div class="card-body">
        <form action="{{route('devises.store')}}" method="post" id="bigform">
            ...
            <div class="client col-md-8">
                <div class="form-group">
                    ...
                    <select name="clients" id="clients" class="form-control">
                        ...
                        <option value="{{$client->id}}" @if($client->id === $client->getClient_Facture_id($avoir->client_id)) selected @endif >{{$client->nom_client}}&nbsp;{{$client->prenom_client}}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            ...
            <div class="col-md-8">
                <div class="form-group">
                    <input value="dupliquer_avoir_devi" name="checked" type="hidden">
                </div>
            </div>
            <div class="col-md-8">
                ...
                <div class="row">
                    <div class="col-md-6 form-group">
                        ...
                        <select name="mode_reglement" id="mode_reglement" class="form-control">
                            ...
                            <option value="Carte bancaire" @if($avoir->mode_regld == 'Carte bancaire') selected @endif>Carte bancaire</option>
                ...
                <div class="row">
                    <div class="col-md-6 form-group">
                        <textarea name="text_introd" cols="30" rows="3" class="form-control"
                            placeholder="Texte d'introduction (visible sur la devis)">{{$avoir->text_introductionf}}</textarea>
                    </div>
                    <div class="col-md-6">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 form-group">
                        <textarea name="text_concld" cols="30" rows="3" class="form-control"
                            placeholder="Texte de conclusion (visible sur la devis)">{{$avoir->text_conclusionf}}</textarea>
                    </div>
                    <div class="col-md-6">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 form-group">
                        <textarea name="text_piedd" cols="30" rows="3" class="form-control"
                            placeholder="Pied de page (visible sur la devis)">{{$avoir->pied_pagef}}</textarea>
                    </div>
                    <div class="col-md-6">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 form-group">
                        <textarea name="text_cond" cols="30" rows="3" class="form-control"
                            placeholder="Conditions de vente (visible sur la devis)"></textarea>
                    </div>
                    <div class="col-md-6">
                    </div>
                </div>
