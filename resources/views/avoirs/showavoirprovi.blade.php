...
<h5 class="text-white d-inline ml-4 text-uppercase"><a href="{{route('avoirs.provi')}}" style="color: white;text-decoration: none">Liste des avoirs <sub>({{$avoirs->count()}})</sub></a> </h5>
...
<div class="contain_inside">
    <div class="etat_div">
        <ul class="list-inline">
            ...
            <li class="list-inline-item"><a href="{{route('avoirs.provi')}}" class="active">PROVISOIRES</a></li>
            <li class="list-inline-item"><a href="{{ route('avoirs.finalise') }}">FINALISÉES</a></li>
            <li class="list-inline-item"><a href="{{ route('avoirs.rembourse') }}">Remboursé</a></li>
        </ul>
    </div>
    <div class="container-fluid mt-4">
                                            ...
                                            <ul>
                                                ...
                                                @foreach ($clients as $client)
                                                    @if($client->getClient_Facture_id($avoir->client_id) != null)
                                                        ...
                                                        <li><a href="{{route('avoirs.editavoir',['avoir_id'=>$avoir->id,'client_id'=>$client->getClient_Facture_id($avoir->client_id)])}}">Modifier</a></li>
                ...
                @else
                    <h2 class="font-weight-bold text-center">
                        Aucun Avoir provisoire pour le moment
                    </h2>
                @endif
    </div>
</div>
