...
<h2 id="grand_title_addclient" class="text-uppercase"><a style="color: white" href="{{route('avoirs.voirplus', ['id'=>$avoir->id]) }}">Avoir&nbsp;{{$avoir->code_avoir}}</a>&nbsp;envoi par email</h2>
@endsection
@section('contenu_inside')
<div class="container-fluid mt-2">
    <form method="POST" action="{{ route('envoi_email_avoir') }}" enctype="multipart/form-data" id="bigform2">
        @csrf
        ...
        <div class="client col-md-8">
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('objet_email') is-invalid @enderror bg-white" id="objet_email" name="objet_email" value="Votre&nbsp;Avoir&nbsp;{{$avoir->code_avoir}}" required>
                @error('objet_email')
                <div class="invalid-feedback">
        ...
        <div class="client col-md-8">
            <div class="form-group">
                ...
                <input type="hidden"  name="avoir_id" value="{{$avoir->id}}">
        ...
        <div class="client col-md-8">
            <div class="form-group">
                ...
                Je vous prie de trouver ci joint votre avoir {{$avoir->code_avoir}} en date {{$avoir->created_at->format('Y-m-d')}}.
