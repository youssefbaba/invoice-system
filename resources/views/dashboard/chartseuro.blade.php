...
<h5 class="text-white ml-4 d-inline text-uppercase"><a href="{{ route('dash.charteuro') }}" style="color: white;text-decoration: none">Dashboard</a> </h5>
...
<div class="etat_div">
    <ul class="list-inline" style="background-color: #F5F5F5">
        <li class="list-inline-item "><a href="{{route('dash.charteuro')}}" class="active">STATISTIQUES</a></li>
