...
<div class="contain_inside">
    <div class="etat_div">
        <ul class="list-inline">
            ...
            <li class="list-inline-item"><a href="{{route('devises.showsigne')}}" class="active" >Signés</a></li>
        </ul>
    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                        @foreach ($clients as $client)
                                                            <a href="{{route('voirplus',$devis->client_id)}}"href="{{route('voirplus',$devis->client_id)}}" class="card-subtitle mb-2  nm_societe mr-5">{{$client->getClient_Facture_Name($devis->client_id)}}&nbsp;&nbsp;{{$client->getClient_Facture_Prenom($devis->client_id)}}</a>
                                                            @break
                                                        @endforeach
                                                </div>
