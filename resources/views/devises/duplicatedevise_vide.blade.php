...
<h2 id="grand_title_addclient" class="text-uppercase">Duplicate devis</h2>
@endsection
    ...
    <div class="card-body">
        <form action="{{route('store_duplicate')}}" method="post" id="bigform">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="number" name="tvad[]" id="tva" class="form-control tva" step="any"
                                value="{{$article->tva}}">
                        </div>
                    </div>
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="number" name="totalttcd[]" id="totalttc" class="form-control totalttc"
            ...
            <div class="row mt-3 col-md-6">
                <div class="col-md-4">
                    <input type="submit" value="Duplicate" name="submit"
