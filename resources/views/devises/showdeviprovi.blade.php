...
{{--  hnaya massayfat les devises li etat dyalhom provisoire et tout les client --}}
<h5 class="text-white d-inline ml-2 text-uppercase"><a href="{{route('devises.showprovi')}}" style="color: white;text-decoration: none;">Liste des devis <sub>({{$devises->count()}})</sub></a>  </h5>
...
<div class="contain_inside">
    <div class="etat_div">
        <ul class="list-inline" style="background-color: #F5F5F5">
            ...
            <li class="list-inline-item text-dark"><a href="{{route('devises.showprovi')}}" class="active">PROVISOIRES</a></li>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                        @foreach ($clients as $client)
                                                            <a href="{{route('voirplus',$devis->client_id)}}" class="card-subtitle mb-2  nm_societe mr-5"><i class="fas fa-user text-muted" style="margin-right: 10px"></i>{{$client->getClient_Facture_code($devis->client_id)}}:{{$client->getClient_Devi_Name($devis->client_id)}}&nbsp;&nbsp;{{$client->getClient_Devi_Prenom($devis->client_id)}}</a>
                                                            @break
                                                        @endforeach
                                                </div>
