...
<h5 class="text-white d-inline ml-4 text-uppercase"><a href="{{route('factures.apayé')}}" style="color: white;text-decoration: none">Liste des factures <sub>({{$factures->count()}})</sub></a> </h5>
...
<div class="contain_inside">
    <div class="etat_div">
        ...
        <li class="list-inline-item "><a href="{{route('factures.index')}}">TOUTES</a></li>
            ...
            <li class="list-inline-item"><a href="{{route('factures.apayé')}}" class="active">À PAYER</a></li>
        </ul>
    </div>
    <div class="container-fluid mt-4">
                                        ...
                                        <div class="absolute" style="z-index:100;">
                                            <ul>
                                                ...
                                                @if($client->getClient_Facture_id($facture->client_id) != null)
                                                    <li><a href="{{route('factures.apayé',$facture->id)}}">Marquer comme Payée</a></li>
                                                    <hr>
                ...
                @else
                    <h2 class="font-weight-bold text-center">
                      Aucun facture apayée pour le moment
                    </h2>
                @endif
    </div>
</div>
