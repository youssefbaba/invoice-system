...
<h5 class="text-white d-inline ml-4 text-uppercase"><a href="{{route('factures.provi')}}" style="color: white;text-decoration: none">Liste des factures <sub>({{$factures->count()}})</sub></a> </h5>
...
<div class="contain_inside">
    <div class="etat_div">
        <ul class="list-inline" style="background-color: #F5F5F5">
            ...
            <li class="list-inline-item text-dark"><a href="{{route('factures.provi')}}" class="active">PROVISOIRES</a></li>
    ...
    <div class="container-fluid pt-2 m-3">
                ...
                @else
                    <h2 class="font-weight-bold text-center">
                        Aucun facture provisoire pour le moment
                    </h2>
                @endif
    </div>
</div>
