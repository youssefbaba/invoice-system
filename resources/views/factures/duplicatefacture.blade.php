...
<h2 id="grand_title_addclient" class="text-uppercase">Dupliquer&nbsp;facture</h2>
@endsection
...
<div class="contain_inside">
    <div class="card-body">
        <form action="{{route('factures.store')}}" method="post" id="bigform">
            ...
            <div class="col-md-8">
                <div class="form-group">
                    <input value="dupliquer_factutre" type="hidden" name="check" >
                </div>
            </div>
            <div class="col-md-8">
                <div class="form-group">
                    <label for="tva">Tva Pour Facture (%)</label>
                    <input value="" onchange="change()" type="number" name="tva[]" id="tvashow" class="form-control showtva"
                        step="any">
                        @error('tva')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
            ...
            <div class="row">
                <div class="d-flex justify-content-end contain_button_submit mt-2" style="padding-left: 30px;padding-top: 10px;">
                    <a href="{{ url()->previous() }}" class="btn addclient_retour btn-danger rounded font-weight-bold"><span><i class="fas fa-backspace font-weight-bold " style="margin-right:-4px"></i></span> Annuler</a>
                     <button type="submit" id="addclient_sumbit_button" class=" btn btn-success rounded font-weight-bold"><span><i class="fas fa-clone font-weight-bold"></i></span>Dupliquer la facture</button>
                </div>
                <div class="col-md-6">
                </div>
            </div>
...
@endsection
@section('script')
<script src="{{asset('js/duplicatefacture.js')}}"></script>
<script>
