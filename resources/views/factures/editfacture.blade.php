        ...
        <form action="{{route('factures.update',$facture->id)}}"  method="POST" id="bigform">
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input value="" onchange="change()" name="tva[]" type="number" id="tvashow" class="form-control showtva"
                        step="any">
                        @error('tva')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
            ...
            <div class="row">
                <div class="d-flex justify-content-end contain_button_submit mt-2" style="padding-left:30px;padding-top:10px;">
                    ...
                    <button type="submit" id="addclient_sumbit_button" class=" btn btn-warning rounded font-weight-bold"><span><i class="far fa-edit font-weight-bold" style="color:#212529"></i></span>Modifier la facture</button>
                </div>
                <div class="col-md-6">
                </div>
            </div>
...
@endsection
@section('script')
<script src="{{asset('js/editfacture.js')}}"></script>
<script>
